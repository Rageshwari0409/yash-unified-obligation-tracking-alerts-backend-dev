    ...
    async def initialize_db_pool(self):
        ...
        try:
            ...
            if not all([db_host, db_port, db_name, db_user, db_password]):
                raise ValueError("All database environment variables (LLM_CONFIG_DB_HOST, LLM_CONFIG_DB_PORT, LLM_CONFIG_DB_NAME, LLM_CONFIG_DB_USER, LLM_CONFIG_DB_PASSWORD) are required")
